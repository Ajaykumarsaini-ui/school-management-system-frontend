...
const CreateExamschedule = () => {
  ...
  const { add: addSchedule , error: scheduleError , loading: scheduleLoading } = useSchedule();
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 rounded-sm shadow-sm space-y-4">
        ...
        <div className="text-center mt-6">
          <Button type="submit" className="schedule-create-btn">
            {classLoading || subjectLoading ? "Loading..." :  scheduleLoading ? "Creating..." : "Create Schedule"}
          </Button>
        </div>
      </form>
    </div>
